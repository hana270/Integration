...
export class PaymentService {
 ...
 private apiUrl: string;
  ...
  initiatePayment(request: PaymentRequest): Observable<PaymentResponse> {
    ...
    return this.http.post<PaymentResponse>(`${this.apiUrl}/payments/initiate`, request, { headers })
      .pipe(
  ...
  verifyCode(
    ...
    return this.http
      .post<PaymentValidationResponse>(`${this.apiUrl}/payments/verify`, request, {
  ...
  resendVerificationCode(transactionId: string): Observable<any> {
    return this.http
      .post<any>(
        `${this.apiUrl}/payments/resend-code`,
        { transactionId },
        {
          headers: this.getAuthHeaders(),
        }
