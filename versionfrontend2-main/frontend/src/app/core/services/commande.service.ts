...
export class CommandeService {
 ...
 private panierUrl:string;
  ...
  constructor(
    ...
    this.panierUrl = this.configService.aquatresorApiUrl;
  ...
  checkBackendStatus(): Observable<any> {
    return this.http
      .get(`${this.apiUrl}/commandes/health`, {
  ...
  getCommandesClient(clientId: number): Observable<Commande[]> {
    return this.http
      .get<Commande[]>(`${this.apiUrl}/commandes/client/${clientId}`, {
        headers: this.getHeaders(),
      })
      .pipe(
        catchError((error) => {
  ...
  traiterPaiement(request: PaiementRequest): Observable<void> {
    return this.http
      .post<void>(`${this.apiUrl}/commandes/paiement`, request, {
        headers: this.getHeaders(),
      })
      .pipe(
        catchError((error) => {
  ...
  annulerCommande(numeroCommande: string): Observable<void> {
    return this.http
      .delete<void>(`${this.apiUrl}/commandes/${numeroCommande}/annuler`, {
        headers: this.getHeaders(),
      })
      .pipe(
        catchError((error) => {
  ...
  getCommande(identifier: string | number): Observable<Commande> {
    ...
    const endpoint = isNumericId 
      ? `${this.apiUrl}/commandes/by-id/${identifier}`
      : `${this.apiUrl}/commandes/${identifier}`;
  ...
  updateOrderStatus(commandeId: string): Observable<Commande> {
    ...
    return this.http.put<Commande>(`${this.apiUrl}/commandes/${commandeId}/statut`, updateData, {
      headers: this.getHeaders(),
    }).pipe(
      tap(updatedOrder => {
